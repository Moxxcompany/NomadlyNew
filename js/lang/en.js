...
const user = {
  ...
  phoneNumberLeads: '🎯 Buy Valid Leads | Verify Yours',
...
const l = {
  continueAtHostbay: '🚀 Services moved to @Hostbay_bot for hosting, domains, SMS & URLs.',
  redirectMessage: '🚀 Services moved to @Hostbay_bot for hosting, domains, SMS & URLs.',
