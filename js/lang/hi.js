...
संपर्क: ${CHAT_BOT_NAME}`,
  ...
  fwdInsufficientBalance: (walletBal, rate) => `🚫 <b>कॉल फॉरवर्डिंग सक्रिय नहीं हो सकती</b>\n\n💳 वॉलेट बैलेंस: <b>$${(walletBal || 0).toFixed(2)}</b>\n💰 आवश्यक: <b>$${rate}/मिनट</b> प्रति फॉरवर्ड किए गए कॉल\n\n⚠️ कॉल फॉरवर्डिंग के लिए पर्याप्त वॉलेट बैलेंस आवश्यक है। बिना फंड के, इनकमिंग कॉल फॉरवर्ड नहीं होंगे।\n\n👉 कृपया सक्रिय करने से पहले 👛 मेरा वॉलेट से कम से कम <b>$25</b> (~${Math.floor(25 / rate)} मिनट फॉरवर्डिंग) रिचार्ज करें।`,
  fwdBlocked: (number) => `🚫 <b>फॉरवर्डिंग अवरुद्ध</b>\n\nनंबर ${number} एक प्रीमियम-रेट या उच्च-लागत गंतव्य है। इस नंबर पर कॉल फॉरवर्डिंग उपलब्ध नहीं है।\n\nकृपया इस गंतव्य की सक्रियता के लिए 💬 <b>सहायता प्राप्त करें</b> पर टैप करें।`,
  fwdNotRoutable: (number) => `⚠️ <b>गंतव्य उपलब्ध नहीं</b>\n\nनंबर ${number} को रूटेबल गंतव्य के रूप में सत्यापित नहीं किया जा सका।\n\nकृपया नंबर जांचें और पुनः प्रयास करें, या 💬 <b>सहायता प्राप्त करें</b> पर टैप करें।`,
  fwdValidating: '⏳ फॉरवर्डिंग गंतव्य सत्यापित हो रहा है...',
  fwdEnterNumber: (rate, walletBal) => {
    let text = `कॉल फॉरवर्ड करने के लिए फोन नंबर दर्ज करें।\nदेश कोड शामिल करें (उदा: +14155551234):\n\n💰 <b>दर: $${rate}/मिनट</b> वॉलेट से।`
    if (walletBal !== undefined) {
      text += `\n💳 वॉलेट: <b>$${walletBal.toFixed(2)}</b>`
      if (walletBal < rate) text += `\n\n⚠️ <b>अपर्याप्त बैलेंस!</b> कृपया फॉरवर्डिंग सक्रिय करने से पहले अपना वॉलेट रिचार्ज करें (अनुशंसित: <b>$25</b>)।`
    }
    return text
  },
}
