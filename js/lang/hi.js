...
संपर्क: ${CHAT_BOT_NAME}`,
  ...
  freeLinksExhausted: `आपके सभी मुफ्त Shortit लिंक समाप्त हो गए हैं! असीमित Shortit लिंक, मुफ्त ".sbs/.xyz" डोमेन और अधिक के लिए सब्सक्राइब करें। प्लान चुनने के लिए "🔔 सब्सक्राइब करें" दबाएं।`,
  linksRemaining: count => `आपके पास ${count} मुफ्त Shortit लिंक शेष हैं।`,
...
const redSelectProvider = ['Bit.ly $10', 'Shortit (मुफ्त)']
