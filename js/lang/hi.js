...
${
  ...
  comingSoonWithdraw: `निकासी अभी उपलब्ध नहीं है। मदद चाहिए? ${SUPPORT_USERNAME} से संपर्क करें।`,
...
संपर्क: ${CHAT_BOT_NAME}`,
  ...
  redIssueUrlBitly: `लिंक शॉर्टनिंग विफल हुई। आपका वॉलेट चार्ज नहीं हुआ। कृपया पुनः प्रयास करें या ${SUPPORT_USERNAME} से संपर्क करें।`,
  redIssueSlugCuttly: `वांछित लिंक नाम पहले से ही लिया गया है, कृपया दूसरा प्रयास करें।`,
  redIssueUrlCuttly: `लिंक शॉर्टनिंग विफल हुई। कृपया पुनः प्रयास करें या ${SUPPORT_USERNAME} से संपर्क करें।`,
